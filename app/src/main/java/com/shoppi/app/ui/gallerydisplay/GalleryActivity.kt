...
package com.shoppi.app.ui.gallerydisplay
...
import com.shoppi.app.ui.gallerydisplay.sub.cameracapture.CameraPreviewActivity
        ...
        try {
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    for (i in alImages2.indices) {
                        if (alImages2[i].getStrFolder() == cursor.getString(
                    ...
                    if (booleanFolder2) {
                        ...
                        alUri.addAll(alImages2[nPos].getAlImageuri())
                        alUri.add(contentUri)
                        alImages2[nPos].setAlImageuri(alUri)
                    } else {
                        val alUri = ArrayList<Uri>()
                        alUri.add(contentUri)
            ...
            objAdapter = AdapterPhotosFolder(applicationContext, alImages2)
