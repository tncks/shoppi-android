...
import com.shoppi.app.otherresource.external.somelandscapes.dataOfOtherStatic
...
class SelectingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = MyAdapter(this@SelectingActivity.alImages3, applicationContext)
